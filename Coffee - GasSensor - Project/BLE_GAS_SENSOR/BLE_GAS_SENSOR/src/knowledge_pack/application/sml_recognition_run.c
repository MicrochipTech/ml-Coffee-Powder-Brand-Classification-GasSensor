//#include "kb.h"
#include "knowledge_pack/mplabml/inc/kb.h"
#include "knowledge_pack/mplabml/inc/kb_output.h"
#include <string.h>
...
//        SERCOM0_USART_WriteByte(0xA5);
        ...
        class_map[1u] = 0u;//Biceps Curl//
        class_map[2u] = 0u;//Lateral Raise//
        class_map[3u] = 0u;//Shoulder Press//
        switch(ret)
        {
          case 0u:
              class_map[0u]=1u;
...
//        printf("Result: %ld\r\n", ret);
//        printf("Result: %d\t%d\t%d\t%d",class_map[0u])
